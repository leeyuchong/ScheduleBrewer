    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courseID', models.ForeignKey(db_column='courseID', on_delete=django.db.models.deletion.CASCADE, to='CourseBrowser.courseinfo')),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('userID', 'courseID'), name='unique_pairing'),
        ),
    ]
