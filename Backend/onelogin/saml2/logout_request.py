...
class OneLogin_Saml2_Logout_Request(object):
    ...
    def __init__(
        ...
        if request is None:
            ...
            if (
                name_id_format
                and name_id_format == OneLogin_Saml2_Constants.NAMEID_ENTITY
            ):
                nq = None
                spnq = None
    ...
    def is_valid(self, request_data, raise_exceptions=False):
        ...
        try:
            ...
            get_data = (
                "get_data" in request_data and request_data["get_data"]
            ) or dict()
