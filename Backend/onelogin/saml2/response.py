...
class OneLogin_Saml2_Response(object):
    ...
    def is_valid(self, request_data, request_id=None, raise_exceptions=False):
        ...
        try:
            ...
            if self.__settings.is_strict():
                ...
                for scn in subject_confirmation_nodes:
                    ...
                    if sc_data is None:
                        ...
                        if nb:
                            parsed_nb = (
                                OneLogin_Saml2_Utils.parse_SAML_to_time(nb)
                            )
            ...
            if not signed_elements or (
                ...
                if (
                    has_signed_response
                    and not OneLogin_Saml2_Utils.validate_sign(
                        self.document,
                        cert,
                        fingerprint,
                        fingerprintalg,
    ...
    def get_session_not_on_or_after(self):
        ...
        authn_statement_nodes = self.__query_assertion(
    ...
    def process_signed_elements(self):
        ...
        for sign_node in sign_nodes:
            ...
            if (
                signed_element != response_tag
                and signed_element != assertion_tag
            ):
                raise OneLogin_Saml2_ValidationError(
    ...
    def __query_assertion(self, xpath_expr):
        ...
        signed_assertion_query = (
            "/samlp:Response" + assertion_expr + signature_expr
        )
