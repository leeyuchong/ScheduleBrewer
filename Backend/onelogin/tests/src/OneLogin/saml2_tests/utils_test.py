...
class OneLogin_Saml2_Utils_Test(unittest.TestCase):
    ...
    def testRedirect(self):
        ...
        self.assertEqual(
            "http://%s/example?%s" % (hostname, parameters2_str), target_url7
        )
    ...
    def testGetselfhost(self):
        ...
        self.assertEqual(
            "example.com", OneLogin_Saml2_Utils.get_self_host(request_data)
        )
    ...
    def testGetSelfRoutedURLNoQuery(self):
        ...
        url_4 = (
            OneLogin_Saml2_Utils.get_self_url_host(request_data_4)
            + "/example1/route/test/"
        )
        self.assertEqual(
            url_4,
        ...
        url_5 = (
            OneLogin_Saml2_Utils.get_self_url_host(request_data_5)
            + "/example1/route/test/"
        )
        self.assertEqual(
            url_5,
        ...
        url_6 = (
            OneLogin_Saml2_Utils.get_self_url_host(request_data_6)
            + "/example1/route/test/"
        )
        self.assertEqual(
            url_6,
    ...
    def testDecryptElement(self):
        ...
        decrypted_assertion = OneLogin_Saml2_Utils.decrypt_element(
        ...
        encrypted_nameid_nodes_2 = dom_nameid_enc_2.getElementsByTagName(
            "saml:EncryptedID"
        )
        ...
        encrypted_nameid_nodes_3 = dom_nameid_enc_3.getElementsByTagName(
            "saml:EncryptedID"
        )
    ...
    def testValidateSign(self):
        ...
        self.assertFalse(
            OneLogin_Saml2_Utils.validate_sign(
                xml_response_msg_signed, cert, validatecert=True
            )
        )
        ...
        f.close()
        self.assertFalse(
            OneLogin_Saml2_Utils.validate_sign(xml_response_msg_signed, cert_x)
        )
        self.assertFalse(
            OneLogin_Saml2_Utils.validate_sign(
                xml_response_msg_signed, cert_x, validatecert=True
            )
        )
        ...
        self.assertTrue(
            OneLogin_Saml2_Utils.validate_sign(
                xml_response_msg_signed_2, None, fingerprint_2
            )
        )
        self.assertTrue(
            OneLogin_Saml2_Utils.validate_sign(
        ...
        self.assertFalse(
            OneLogin_Saml2_Utils.validate_sign(
                xml_response_assert_signed, cert, validatecert=True
            )
        )
        ...
        self.assertTrue(
            OneLogin_Saml2_Utils.validate_sign(
                xml_response_assert_signed_2, None, fingerprint_2
            )
        )
        ...
        self.assertFalse(
            OneLogin_Saml2_Utils.validate_sign(
                xml_response_double_signed, cert, validatecert=True
            )
        )
        ...
        self.assertTrue(
            OneLogin_Saml2_Utils.validate_sign(
                xml_response_double_signed_2, None, fingerprint_2
            )
        )
