...
class TestOneLoginSaml2Xml(unittest.TestCase):
    ...
    def testValidateXML(self):
        ...
        res = OneLogin_Saml2_XML.validate_xml(
            metadata_unloaded, "saml-schema-metadata-2.0.xsd"
        )
        ...
        res = OneLogin_Saml2_XML.validate_xml(
            metadata_invalid, "saml-schema-metadata-2.0.xsd"
        )
        self.assertIsInstance(res, str)
    ...
    def testQuery(self):
        ...
        signature_nodes_3 = OneLogin_Saml2_XML.query(
            dom, "./ds:SignatureValue", assertion
        )
        ...
        signature_nodes_5 = OneLogin_Saml2_XML.query(
            dom, ".//ds:SignatureValue", assertion
        )
