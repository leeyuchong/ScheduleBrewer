...
class OneLogin_Saml2_Logout_Request_Test(unittest.TestCase):
    ...
    def assertRegex(self, text, regexp, msg=None):
        if hasattr(unittest.TestCase, "assertRegex"):
            return super(OneLogin_Saml2_Logout_Request_Test, self).assertRegex(
                text, regexp, msg
            )
        else:
    ...
    def testConstructor(self):
        ...
        self.assertRegex(
            logout_url,
            r"^http://idp\.example\.com\/SingleLogoutService\.php\?SAMLRequest=",
        )
    ...
    def testGetNameIdData(self):
        ...
        name_id_data_3 = OneLogin_Saml2_Logout_Request.get_nameid_data(
            logout_request.get_xml()
        )
        ...
        logout_request = OneLogin_Saml2_Logout_Request(settings)
        name_id_data_5 = OneLogin_Saml2_Logout_Request.get_nameid_data(
            logout_request.get_xml()
        )
